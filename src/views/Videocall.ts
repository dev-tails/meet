...
function twoPeopleLayout(
  ...
  secondary.style.height = '20%';
  secondary.style.margin = '12px';
  ...
  if (otherUser) {
    ...
    otherUser.style.width = '100%';
    otherUser.style.height = '100%';
    otherUserVideo.style.width = '';
    otherUserVideo.style.height = '';
